...
<section class="team-member-highlight" style="background-image: url(<?php echo $temp_dir ?>/img/home/Entrepreneur_1_Background@2x.png);">
    <div class="wrapper">
        <div class="row">
...
<?php if($dark->posts[0]) : ?>
<section class="team-member-highlight dark image-first" style="background-image: url(<?php echo $temp_dir ?>/img/home/Entrepreneur_2_Background@2x.png);">
    <div class="wrapper">
        <div class="row">
            <div class="row-height">
                <div class="col-md-7 col-md-height image">
...
<section class="team-member-highlight" style="background-image: url(<?php echo $temp_dir ?>/img/home/Entrepreneur_3_Background@2x.png);">
    <div class="wrapper">
        <div class="row">
            <div class="row-height">
                <div class="col-md-7 col-md-height image">
