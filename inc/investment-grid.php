...
?>
	...
	<div class="col-md-4">
        <div class="inner <?php if( $post->ID == $currentID ){ echo 'current'; } ?>">
            ...
            <img src="<?php echo $temp_dir ?>/img/investments/Investment_Block_<?php echo $total_counter ?>@1x.jpg" srcset="<?php echo $temp_dir ?>/img/investments/Investment_Block_<?php echo $total_counter ?>@1x.jpg 420w, <?php echo $temp_dir ?>/img/investments/Investment_Block_<?php echo $total_counter ?>@2x.jpg 840w" sizes="(min-width:992px) 33vw, 100vw" class="bg-img" />
        </div>
    </div>
